...
export const Toolbar = ({ className }: ToolbarProps) => {
  const { addTodo, todos, clearAllTodos, saveTodoLayout, loadTodoLayout, exportTodos, importTodos } = useTodoStore();
  ...
  const handleLoadLayout = () => {
    try {
      ...
      toast.error("Erro ao carregar layout", {
        description: "O layout salvo parece estar corrompido ou em formato inválido."
      });
    }
  };
